...
const validationsSchema = yup.object().shape({
  ...
  .max(yup.ref('cWeight'), 'Максимальное значение не может быть больше текущего')
  .required('Обязательно'),
})
            ...
            handleBlur, isValid, handleSubmit, dirty}) => (
              ...
              <div className={styles.formContainerLeft}>
                ...
                <FormControl component="fieldset">
                  <StyleFormLabel component="legend">Группа крови *</StyleFormLabel>
                  <RadioGroup row aria-label="position" name="bloodType" defaultValue="top">
                    <FormControlLabel onChange={handleChange} onBlur={handleBlur} value="1" control={<StyleRadio />} label="1" />
                    <FormControlLabel onChange={handleChange} onBlur={handleBlur} value="2" control={<StyleRadio />} label="2" />
                    <FormControlLabel onChange={handleChange} onBlur={handleBlur} value="3" control={<StyleRadio />} label="3" />
                    <FormControlLabel onChange={handleChange} onBlur={handleBlur} value="4" control={<StyleRadio />} label="4" />
                  </RadioGroup>
                </FormControl>
                </div>
                </div>
